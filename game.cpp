...
void health()
{
if (getCharAtxy(pX, pY-1) == '$' || getCharAtxy(pX + 1, pY-1) == '$' || getCharAtxy(pX + 2, pY-1) == '$' || getCharAtxy(pX, pY+2) == '$' || getCharAtxy(pX + 1, pY + 2) == '$' || getCharAtxy(pX + 2, pY + 2) == '$' || getCharAtxy(pX+3, pY) == '$' || getCharAtxy(pX + 3, pY + 1) == '$' || getCharAtxy(pX-1, pY) == '$' || getCharAtxy(pX - 1, pY +1) == '$') {
